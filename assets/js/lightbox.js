(function ($) {
    ...
    Lightbox.defaults = {
        ...
        showTitle: hugeit_resp_lightbox_obj.hugeit_lightbox_showTitle,
        showDesc: hugeit_resp_lightbox_obj.hugeit_lightbox_showDesc,
        showBorder: hugeit_resp_lightbox_obj.hugeit_lightbox_border,
        borderSize: hugeit_resp_lightbox_obj.hugeit_lightbox_bordersize,
        borderColor: hugeit_resp_lightbox_obj.hugeit_lightbox_bordercolor,
        borderRadius: hugeit_resp_lightbox_obj.hugeit_lightbox_borderradius,
        borderOpacity: hugeit_resp_lightbox_obj.hugeit_lightbox_borderopacity,
        onImageLink: hugeit_resp_lightbox_obj.hugeit_lightbox_enableURL,
        imageLink: hugeit_resp_lightbox_obj.hugeit_lightbox_imageLink,
        imageLinkNewTab: hugeit_resp_lightbox_obj.hugeit_lightbox_linkNewTab,
        ...
        wText: hugeit_resp_lightbox_obj.hugeit_lightbox_watermark_text,
        share: {
    ...
    Lightbox.prototype.structure = function (index) {
        ...
        $(window).on('resize.rwd-container', function () {
            ...
            if(hugeit_resp_lightbox_obj.hugeit_lightbox_imageframe !== 'frame_0' && !hugeit_resp_lightbox_obj.hugeit_lightbox_imageborder){
                $('.rwd-image').css({
                    top: 'calc(50% - 60px)'
                });
            }

            if(hugeit_resp_lightbox_obj.hugeit_lightbox_imageborder){
                $('.rwd-image').css({
                    top: 'calc(50% - ' + hugeit_resp_lightbox_obj.hugeit_lightbox_imagebordersize + 'px)'
                });
            }
        });
        ...
        switch($object.settings.lightboxView){
            ...
            case 'view2':
            case 'view3':
                var $h = 2*Math.abs(hugeit_resp_lightbox_obj.hugeit_lightbox_imageshadowv) + 92, $t;

                if(hugeit_resp_lightbox_obj.hugeit_lightbox_imageshadowv < 0){
                    $t = Math.abs(hugeit_resp_lightbox_obj.hugeit_lightbox_imageshadowv) + 47;
                } else {
                    $t = 47;
                }
                $inner.css({
            ...
            case 'view4':
                ...
                break;
            case 'view5':
                var $w = Math.abs(hugeit_resp_lightbox_obj.hugeit_lightbox_imageshadowh) + 'px', $l;

                if(hugeit_resp_lightbox_obj.hugeit_lightbox_imageshadowh < 0){
                    $l = Math.abs(hugeit_resp_lightbox_obj.hugeit_lightbox_imageshadowh);
    ...
    Lightbox.prototype.loadContent = function (index, rec, delay) {
        ...
        function _hexToRGBA() {
            var hex, opacity, bigint, r, g, b;
            hex = hugeit_resp_lightbox_obj.hugeit_lightbox_imagebordercolor;
            opacity = hugeit_resp_lightbox_obj.hugeit_lightbox_imageborderopacity / 100;
            bigint = parseInt(hex, 16);
            r = (bigint >> 16) & 255;
            g = (bigint >> 8) & 255;
            b = bigint & 255;
        ...
        if(hugeit_resp_lightbox_obj.hugeit_lightbox_imageborder){
            $('.rwd-image').css({
                border: hugeit_resp_lightbox_obj.hugeit_lightbox_imagebordersize + 'px solid ' + _hexToRGBA(),
                borderRadius: hugeit_resp_lightbox_obj.hugeit_lightbox_imageborderradius + 'px'
            });
        }

        if(hugeit_resp_lightbox_obj.hugeit_lightbox_imageshadow && (hugeit_resp_lightbox_obj.hugeit_lightbox_imageframe === 'frame_0' || hugeit_resp_lightbox_obj.hugeit_lightbox_imageborder)){
            var $shadowH = hugeit_resp_lightbox_obj.hugeit_lightbox_imageshadowh + 'px ',
                $shadowV = hugeit_resp_lightbox_obj.hugeit_lightbox_imageshadowv + 'px ',
                $blur = hugeit_resp_lightbox_obj.hugeit_lightbox_imageshadow_blur + 'px ',
                $spread = hugeit_resp_lightbox_obj.hugeit_lightbox_imageshadow_spread + 'px ',
                $color = '#' + hugeit_resp_lightbox_obj.hugeit_lightbox_imageshadow_color;
    ...
    Lightbox.prototype.slide = function (index, fromSlide, fromThumb) {
        ...
        $('.rwd-container .rwd-thumb-item img').css({
            opacity: 1 - +hugeit_resp_lightbox_obj.hugeit_lightbox_thumbs_overlay_opacity / 100
        });
    ...
    Lightbox.prototype.goToNextSlide = function (fromSlide) {
        ...
        if(hugeit_resp_lightbox_obj.hugeit_lightbox_zoom){
            $cont.find('.rwd-image').eq($object.index - 1).attr('style', '');
            $cont.find('.rwd-image').eq($object.index - 1).parents('.rwd-img-wrap').attr('style', '');
        }
    };
    ...
    Modul.defaultsModul = {
        ...
        thumbsWidth: +hugeit_resp_lightbox_obj.hugeit_lightbox_thumbs_width,
        thumbsHeight: +hugeit_resp_lightbox_obj.hugeit_lightbox_thumbs_height,
        thumbMargin: +hugeit_resp_lightbox_obj.hugeit_lightbox_thumbs_margin,
        showByDefault: true,
        toogleThumb: false,
        thumbPosition: hugeit_resp_lightbox_obj.hugeit_lightbox_thumbs_position,
        thumbsOverlayColor: hugeit_resp_lightbox_obj.hugeit_lightbox_thumbs_overlay_color,
        thumbsOverlayOpacity: hugeit_resp_lightbox_obj.hugeit_lightbox_thumbs_overlay_opacity,
        fullscreen: hugeit_resp_lightbox_obj.hugeit_lightbox_fullscreen_effect
    };
    ...
    Modul.prototype.offFullWidth = function () {
        ...
        if((hugeit_resp_lightbox_obj.hugeit_lightbox_imageframe !== 'frame_0' && !hugeit_resp_lightbox_obj.hugeit_lightbox_imageborder) || hugeit_resp_lightbox_obj.hugeit_lightbox_imageborder){
                ...
                switch($object.dataL.settings.lightboxView){
                    case 'view1':
                        switch($object.dataL.modulSettings.thumbPosition){
                            case '0':
                                $cont_.css({
                                    height: 'calc(100% - ' + ($object.dataL.modulSettings.thumbsHeight + 2*Math.abs(hugeit_resp_lightbox_obj.hugeit_lightbox_imageshadowv) + 92) + 'px)',
                                    top: Math.abs(hugeit_resp_lightbox_obj.hugeit_lightbox_imageshadowv) + 47 + 'px'
                                });
                                $thumb_.css({
                                    bottom: '0',
                            ...
                            case '1':
                                $cont_.css({
                                    height: 'calc(100% - ' + ($object.dataL.modulSettings.thumbsHeight + Math.abs(hugeit_resp_lightbox_obj.hugeit_lightbox_imageshadowv) + 92) + 'px)',
                    ...
                    case 'view2':
                        switch($object.dataL.modulSettings.thumbPosition) {
                            case '0':
                                $cont_.css({
                                    height: 'calc(100% - ' + ($object.dataL.modulSettings.thumbsHeight + Math.abs(hugeit_resp_lightbox_obj.hugeit_lightbox_imageshadowv) + 92) + 'px)',
                                    top: Math.abs(hugeit_resp_lightbox_obj.hugeit_lightbox_imageshadowv) + 45 + 'px'
                                });
                                $thumb_.css({
                                    bottom: '45px',
                                    backgroundColor: 'rgba(0,0,0,.9)'
                    ...
                    case 'view3':
                        switch($object.dataL.modulSettings.thumbPosition) {
                            ...
                            case '1':
                                $cont_.css({
                                    height: 'calc(100% - ' + ($object.dataL.modulSettings.thumbsHeight + Math.abs(hugeit_resp_lightbox_obj.hugeit_lightbox_imageshadowv) + 93) + 'px)',
                    ...
                    case 'view4':
                        switch($object.dataL.modulSettings.thumbPosition) {
                            ...
                            case '1':
                                $cont_.css({
                                    height: 'calc(100% - ' + ($object.dataL.modulSettings.thumbsHeight + Math.abs(hugeit_resp_lightbox_obj.hugeit_lightbox_imageshadowv) + 90) + 'px)',
                                    top: $object.dataL.modulSettings.thumbsHeight + 45 + 'px'
                                });
                                $thumb_.css({
                                    top: '45px',
                    ...
                    case 'view5':
                        switch($object.dataL.modulSettings.thumbPosition) {
                            case '0':
                                $cont_.css({
                                    height: 'calc(100% - ' + ($object.dataL.modulSettings.thumbsHeight + Math.abs(hugeit_resp_lightbox_obj.hugeit_lightbox_imageshadowv)) + 'px)',
                                    top: Math.abs(hugeit_resp_lightbox_obj.hugeit_lightbox_imageshadowv) + 'px'
                                });
                                $thumb_.css({
                                    bottom: '0'
                                });
    ...
    Modul.prototype.destroy = function () {
        ...
        if (hugeit_resp_lightbox_obj.hugeit_lightbox_thumbs) {
    ...
    WaterMark.defaults = {
        ...
        opacity: +hugeit_resp_lightbox_obj.hugeit_lightbox_watermark_containerOpacity / 100,
