...
<div class="row">
    ...
    <div class="filtr-container">
        <div class="col-xs-6 col-sm-4 col-md-3 filtr-item" data-category="53" data-sort="Busy streets">
            <img class="img-responsive" src="img/city_1.jpg" alt="sample image">
        </div>
        <div class="col-xs-6 col-sm-4 col-md-3 filtr-item" data-category="54" data-sort="Luminous night">
            <img class="img-responsive" src="img/nature_2.jpg" alt="sample image">
        </div>
        <div class="col-xs-6 col-sm-4 col-md-3 filtr-item" data-category="55" data-sort="City wonders">
            <img class="img-responsive" src="img/city_3.jpg" alt="sample image">
        </div>
        <div class="col-xs-6 col-sm-4 col-md-3 filtr-item" data-category="56" data-sort="In production">
