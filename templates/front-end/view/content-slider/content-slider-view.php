		...
		<div class="slider-content">
			<div class="slider-content-wrapper">
					...
					switch ( $imagerowstype ) {
							...
							<a class="gallery_group<?php echo $galleryID; ?> ph-lightbox" href="<?php echo $imgurl[0]; ?>"
							   title="<?php echo str_replace( '__5_5_5__', '%', $row->name ); ?>"><img
									...
									src="<?php echo esc_url( photo_gallery_wp_get_image_by_sizes_and_src( $imgurl[0], array(
										Photo_Gallery_WP()->settings->view5_main_image_width,''	), false ) ); ?>"/></a>
						<?php } else { ?>
						...
						case 'video':
							...
							if ( $videourl[1] == 'youtube' ) {
								?>
								<a class="gallery_group<?php echo $galleryID; ?> giyoutube huge_it_gallery_item ph-lightbox"
								...
								?>
								<a class="givimeo huge_it_gallery_item ph-lightbox"
				...
				<div class="right-block">                    <?php if ( $row->name != '' && $row->name != null ) { ?>
					...
					<?php if ( Photo_Gallery_WP()->settings->view5_show_description == 'yes' ) { ?>
						<div
					...
					<?php endif; ?>
					<?php if ( Photo_Gallery_WP()->settings->view5_show_linkbutton == 'yes' ) {
						if ( $link != '' ) {
							?>
							<div class="button-block">
								<a href="<?php echo $link; ?>" <?php if ( $row->link_target == "on" ) {
									echo 'target="_blank"';
								} ?>><?php echo Photo_Gallery_WP()->settings->view5_linkbutton_text; ?></a>
							</div>
						<?php }
					} ?>
				</div>
